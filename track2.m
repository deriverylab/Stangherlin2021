function tracks = track2(xyzs,maxdisp,param)
%;
...
% ------------------WARNING-----------------------------
%       modifed by manu 181004
%       Input needs to be XYZT,intensity, Offset, Sigma1, uncertainty
% -----------------------------------------------------------
%
...
%    10/18 ED modified to be able to keep track of 4 parameters (intensity, offset, sigma1, uncertainty)    
%
...
%dd = length(xyzs(1,:));
dd = length(xyzs(1,:))-4; %mofidy by manu 181004 to get (intensity, offset, sigma1, uncertainty)  
...
dd=dd+4;%modify by manu 181004 to get (intensity, offset, sigma1, uncertainty)  
for j=1:dd
